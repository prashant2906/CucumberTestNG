...
public class BrowserUtil {
	//private static //logger //logger = //logger.get//logger(BrowserUtil.class);

	static String chromeDriverPath = "..//TestBDD//Executables//";
	...
	public static WebDriver initChromeDriver(String appURL) {
		...
		System.setProperty("webdriver.chrome.driver", chromeDriverPath + "chromedriver1.exe");
